...
- Out of scope unless the user asks: a second game mode, elevation, reverb/occlusion/Doppler, music, mobile UI/PWA (the no-keyboard notice is text only), new cue sounds, moving hazards, and extra settings beyond speech/volume/contrast.
