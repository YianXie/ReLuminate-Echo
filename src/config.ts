...
export const CUES = {
  ...
  PING: { fromHz: 300, toHz: 1200, duration: 0.12, gain: 0.5, q: 4, attack: 0.008 },

  /** (spec) "You may collect this" — two-tone rising sine, 200 ms. */
  IN_RANGE: { tones: [880, 1320], duration: 0.2, gain: 0.35, attack: 0.01, overlap: 1.4 },

  /** (spec) Target collected — three-tone rising arpeggio, 300 ms. */
  COLLECT: { tones: [660, 880, 1320], duration: 0.3, gain: 0.4, attack: 0.01, overlap: 1.4 },
